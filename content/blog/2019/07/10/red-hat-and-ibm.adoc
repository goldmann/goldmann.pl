...
Maybe employees?::
    ...
    the _Red Hat way_ many people will just resign. So, no, not employees.
Buildings?::
...
here, because IBM alone could not do it. You could try to do the process yourself, but it would take too much time, especially with a company of this size and the process would not be that visible to customers either.
