...
to make our [projects](http://www.jboss.org/projects/) (and
[products](http://www.jboss.org/products/) too!) usable out-of-box for as
...
configuration file with [WildFly](http://wildfly.org/) since there are so
...
[One of the readers
brought up](https://twitter.com/bsideup/status/492050173238181888) that I forgot to mention one great tool:
[Augeas](http://augeas.net/). I’ve [added it now to the list](#_augeas)
and summary.

## TL;DR;

See [summary](#_summary).
...
[WildFly
documentation](https://docs.jboss.org/author/display/WFLY8/Command+line+parameters) has a great summary of the available options.
...
[domain
mode](https://docs.jboss.org/author/display/WFLY8/Operating+modes) (instead of standalone), binds the public endpoint to every
...
> [!NOTE]
> This example is [available on GitHub](https://github.com/goldmann/wildfly-docker-configuration/tree/master/sed).
...
> [!NOTE]
> This example is [available on GitHub](https://github.com/goldmann/wildfly-docker-configuration/tree/master/xmlstarlet).
...
> [!NOTE]
> This example is [available on GitHub](https://github.com/goldmann/wildfly-docker-configuration/tree/master/xslt).
...
[WildFly
team provides examples of xsl files](https://github.com/wildfly/wildfly/tree/8.1.0.Final/testsuite/integration/src/test/xslt). You can use Saxon to execute the transformation:
...
the
[documentation](http://www.saxonica.com/documentation/using-xsl/commandline.html).
...
> [!NOTE]
> This example is [available on GitHub](https://github.com/goldmann/wildfly-docker-configuration/tree/master/cli).

WildFly ships with a powerful CLI. The
[documentation](https://docs.jboss.org/author/display/WFLY8/CLI+Recipes)
...
[my
example](https://github.com/goldmann/wildfly-docker-configuration/tree/master/cli). It adds a new `ExampleMySQLDS` datasource to the server. The main file that does
the job is the
[`execute.sh`](https://github.com/goldmann/wildfly-docker-configuration/blob/master/cli/customization/execute.sh)
script:
...
The
[`commands.cli`](https://github.com/goldmann/wildfly-docker-configuration/blob/master/cli/customization/commands.cli)
...
> [!NOTE]
> This example is [available on GitHub](https://github.com/goldmann/wildfly-docker-configuration/tree/master/custom-file).
...
the
[example](https://github.com/goldmann/wildfly-docker-configuration/tree/master/custom-file).
...
> [!NOTE]
> This example is [available on GitHub](https://github.com/goldmann/wildfly-docker-configuration/tree/master/augeas).

Augeas is a [general purpose configuration editing
tool](http://augeas.net/). It has plugins (lenses) for many configuration files. If your file isn’t
on [the list](http://augeas.net/stock_lenses.html) — don’t worry — you can
